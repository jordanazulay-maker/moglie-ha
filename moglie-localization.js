...
export const MOGLIE_TRANSLATIONS = {
  "en": { // English
    ...
    "morning": "Good morning! The primates and I are preparing for the day! ",
    "afternoon": "Good afternoon! It's a beautiful time for some banana snacks! ",
    "evening": "Good evening! Things are quieting down in the canopy. ",
  ...
  "he": { // Hebrew
    ...
    "morning": "בוקר טוב! הקופים ואני מתכוננים ליום חדש! ",
    "afternoon": "צהריים טובים! זה זמן מצוין לחטיפי בננה! ",
    "evening": "ערב טוב! העניינים נרגעים בצמרות העצים. ",
  ...
  "ar": { // Arabic
    ...
    "morning": "صباح الخير! الرئيسيات وأنا نستعد لليوم! ",
    "afternoon": "طاب مساؤك! إنه وقت جميل لبعض وجبات الموز الخفيفة! ",
    "evening": "مساء الخير! الأمور تهدأ في المظلة. ",
  ...
  "es": { // Spanish
    ...
    "morning": "¡Buenos días! ¡Los primates y yo nos preparamos para el día! ",
    "afternoon": "¡Buenas tardes! ¡Es un hermoso momento para unos bocadillos de plátano! ",
    "evening": "¡Buenas noches! Las cosas se están calmando en el dosel. ",
  ...
  "fr": { // French
    ...
    "morning": "Bonjour ! Les primates et moi nous préparons pour la journée ! ",
    "afternoon": "Bon après-midi ! C'est un beau moment pour quelques collations à la banane ! ",
    "evening": "Bonsoir ! Les choses se calment dans la canopée. ",
  ...
  "de": { // German
    ...
    "morning": "Guten Morgen! Die Primaten und ich bereiten uns auf den Tag vor! ",
    "afternoon": "Guten Tag! Es ist eine schöne Zeit für ein paar Bananensnacks! ",
    "evening": "Guten Abend! In den Baumkronen wird es langsam ruhig. ",
  ...
  "it": { // Italian
    ...
    "morning": "Buongiorno! I primati e io ci prepariamo per la giornata! ",
    "afternoon": "Buon pomeriggio! È un bel momento per degli snack alla banana! ",
    "evening": "Buonasera! Tutto si sta tranquillizzando tra le fronde. ",
  ...
  "pt": { // Portuguese
    ...
    "morning": "Bom dia! Os primatas e eu estamos nos preparando para o dia! ",
    "afternoon": "Boa tarde! É um belo momento para alguns lanches de banana! ",
    "evening": "Boa noite! As coisas estão se acalmando no dossel. ",
  ...
  "nl": { // Dutch
    ...
    "morning": "Goedemorgen! De primaten en ik maken ons klaar voor de dag! ",
    "afternoon": "Goedemiddag! Het is een prachtige tijd voor wat bananensnacks! ",
    "evening": "Goedenavond! Het wordt rustig in de boomkruinen. ",
  ...
  "ru": { // Russian
    ...
    "morning": "Доброе утро! Приматы и я готовимся к новому дню! ",
    "afternoon": "Добрый день! Прекрасное время для банановых закусок! ",
    "evening": "Добрый вечер! В кронах деревьев становится тихо. ",
  ...
  "ja": { // Japanese
    ...
    "night": "群れは林冠で眠っています...",
    "morning": "おはよう！霊長類と私は一日の準備をしています！ ",
    "afternoon": "こんにちは！バナナスナックにぴったりの美しい時間です！ ",
    "evening": "こんばんは！林冠は静かになりつつあります。 ",
  ...
  "zh-CN": { // Chinese (Simplified)
    ...
    "away": "猴群外出了。正在看守树木！",
    "night": "猴群在树冠上睡觉...",
    "morning": "早上好！灵长类动物和我正在为新的一天做准备！ ",
    "afternoon": "下午好！这是一个吃香蕉零食的美丽时刻！ ",
    "evening": "晚上好！树冠里安静下来了。 ",
    "p_patrol": "（灵长类动物在周边巡逻）",
    "p_off": "（灵长类动物下班）",
    "p_alert": "（高度警戒！）",
